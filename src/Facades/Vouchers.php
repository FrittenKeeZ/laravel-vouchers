 ...
 * @method static \FrittenKeeZ\Vouchers\Vouchers                                              withCounter(?int $start = 1)
 * @method static int                                                                         getCounterStep()
 * @method static \FrittenKeeZ\Vouchers\Vouchers                                              withCounterStep(?int $step)
 * @method static string                                                                      getCounterSeparator()
 * @method static \FrittenKeeZ\Vouchers\Vouchers                                              withCounterSeparator(?string $separator)
 * @method static ?int                                                                        getCounterPadding()
 * @method static string                                                                      getCounterPad()
 * @method static \FrittenKeeZ\Vouchers\Vouchers                                              withCounterPadding(?int $length, string $pad = '0')
 * @method static \FrittenKeeZ\Vouchers\Vouchers                                              withoutCounterPadding()
 * @method static ?\Closure                                                                   getCodeFormatter()
 * @method static \FrittenKeeZ\Vouchers\Vouchers                                              withCodeFormatter(?\Closure $formatter)
 ...
 * @method static bool                                                                        redeem(\FrittenKeeZ\Vouchers\Models\Voucher|string $voucher, \Illuminate\Database\Eloquent\Model $entity, array $metadata = [])
 * @method static bool                                                                        unredeem(\FrittenKeeZ\Vouchers\Models\Voucher|string $voucher, ?\Illuminate\Database\Eloquent\Model $entity = null, ?\Closure $callback = null)
 * @method static bool                                                                        redeemable(\FrittenKeeZ\Vouchers\Models\Voucher|string $voucher, ?\Closure $callback = null)
 * @method static bool                                                                        unredeemable(\FrittenKeeZ\Vouchers\Models\Voucher|string $voucher, ?\Closure $callback = null)
